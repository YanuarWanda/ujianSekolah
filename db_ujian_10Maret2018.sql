...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2018 at 12:02 AM
...
(3, 1, 4, 'asda', 75, '02:00:00', '2018-03-05 15:06:11', '2018-03-05 15:06:11', '2018-03-12', 'posted', 'Tidak ada catatan.'),
(4, 1, 4, 'UTS Pemrograman Berorientasi Objek', 75, '02:00:00', '2018-03-06 06:48:55', '2018-03-06 06:48:55', '2018-03-06', 'posted', 'Tidak ada catatan.'),
(5, 2, 4, 'UAS Web Dinamis', 80, '02:00:00', '2018-03-10 13:16:04', '2018-03-10 13:16:04', '2018-03-01', 'posted', 'Ini UAS Loh!');
...
(3, 3, '02:05:00', '2018-03-10 13:26:36', 'Tidak ada catatan. 2', NULL, 'posted'),
(4, 5, '02:00:00', '2018-03-10 13:26:44', 'Tidak ada catatan.', NULL, 'Belum Selesai');
...
(5, 'yesterdayoncemore', 'yesterday.once@gmail.com', '$2y$10$7nWogqSU1MEMCH2VAiO1XedWhrc9GcdQCpjhKrRXaHOrGo58lfJei', 'hE3rnye2qyEec1CTx8VxRMxo26wbtRjW1ysxr1KqWlBmJJC50hzmUzPhNN6O', 'guru', '2018-03-05 14:46:34', '2018-03-05 14:46:34'),
(6, 'yanuarwanda', 'yanuar.wanda2@gmail.com', '$2y$10$V2EqzIhM2H.p2jnCz5ncxeqZ1bXBSjDzA.5hqSC8ifFK.pL.Yx5o2', '9Md9TV70aMJWFqmyXJc9Lc8l6N2ZB9Ylv715sR6RlC7bCIEkuwjjNjgyEAvI', 'siswa', '2018-03-05 14:47:38', '2018-03-05 14:47:38'),
(7, 'wsetiawan', 'wendy.setiawan@gmail.com', '$2y$10$dRq8No6Uu8Rwh0SZehdyEODAfrnmDZQfK4hmkPMPAdX3qL3IOReRS', 'C47GrMriOH3ZJKT2LPRGGWdepxDqehNeuvBsJnZPk2qDWFDccXZD1H61w27T', 'siswa', '2018-03-05 14:48:21', '2018-03-05 14:48:21'),
(8, 'bagja', 'riki.subagja@gmail.com', '$2y$10$yT3WhV84zW0OvwHmvY/dF.gNrfWgOFn9YTLKfdDSGLiU5gbp8V4ey', 'T5nT3JpZGMwZfCmnAcmcOEc7mkUGC5eLKsHXzIq69rDFPxYfYx0Ky6ltrnkO', 'siswa', '2018-03-05 14:48:47', '2018-03-05 14:48:47'),
...
--
ALTER TABLE `bank_soal`
  MODIFY `id_bank_soal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `jawaban_siswa_remed`
  MODIFY `id_jawaban_remedial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `kelas_ujian`
  MODIFY `id_kelas_ujian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `soal_remed`
  MODIFY `id_soal_remedial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `ujian`
--
ALTER TABLE `ujian`
  MODIFY `id_ujian` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key.', AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `ujian_remedial`
--
ALTER TABLE `ujian_remedial`
  MODIFY `id_ujian_remedial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
