...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2018 at 12:42 PM
...
(5, '1921293829182394281', 15, 'sfso', 'My Heart Street', 'P', 'wah_disini_gerah_ya_by_rainn185-d80o2qe_1521944676.jpg');
...
(61, 1, 1, '<p>5+5</p> ,  <p>6+4</p> ,  <p>7+3</p> ,  <p>8+2</p>'),
(62, 2, 1, 'Benar'),
(63, 3, 1, '<p>7</p>'),
(64, 1, 3, '<p>5+5</p> ,  <p>6+4</p> ,  <p>7+3</p> ,  <p>8+2</p>'),
(65, 2, 3, 'Salah'),
(66, 3, 3, '<p>7</p>'),
(67, 1, 2, '<p>8+2</p> ,  <p>6+4</p> ,  <p>5+5</p> ,  <p>7+3</p> ,  <p>2+2</p>'),
(68, 2, 2, 'Benar'),
(69, 3, 2, '<p>7</p>'),
(70, 1, 4, '<p>2+2</p> ,  <p>6+4</p> ,  <p>5+5</p>'),
(71, 2, 4, 'Benar'),
(72, 3, 4, '<p>5</p>');
...
(10, 1, 1, 3, 0, 100, 'Sudah Mengerjakan'),
(11, 1, 3, 2, 1, 14, 'Harus Remedial'),
(12, 1, 2, 2, 1, 95, 'Sudah Mengerjakan'),
(13, 1, 4, 1, 2, 86, 'Sudah Mengerjakan');
...
(1, '1502011462', 6, 2, 'Yanuar Wanda Putra', 'Jalan Marga Asri VI G.', 'L', 'IMG_20170913_130759_1521939746.jpg', ''),
...
(1, 4, 5, 'UTS Matematika Kelas `12', 76, '02:05:00', '2018-03-22 07:42:08', '2018-03-22 07:42:08', '2018-03-21', 'posted', 'Yang nilainya dibawah kkm harus lari di lapang 15 kuliling.', 'N'),
(2, 4, 5, 'UAS Matematika Kelas 12', 45, '02:00:00', '2018-03-25 02:50:22', '2018-03-25 02:50:22', '0000-00-00', 'Draft', 'Ini UAS yah', 'Y');
...
(2, 1, '02:00:00', '2018-03-25 02:02:35', 'Ini remedial pertama.', '2018-03-25 17:00:00', 'posted', 1);
...
(6, 'yanuarwanda', 'yanuar.wanda2@gmail.com', '$2y$10$V2EqzIhM2H.p2jnCz5ncxeqZ1bXBSjDzA.5hqSC8ifFK.pL.Yx5o2', 'LaWnthHmfCoLn4LwJrooo1m0WhCQFdssF9mICq2S0czbFSqtyphWrz3916Eb', 'siswa', '2018-03-05 14:47:38', '2018-03-05 14:47:38'),
(7, 'wsetiawan', 'wendy.setiawan@gmail.com', '$2y$10$dRq8No6Uu8Rwh0SZehdyEODAfrnmDZQfK4hmkPMPAdX3qL3IOReRS', 'ZfRXkr6a1ctck7nikzJmb7SiDuQ5pDzJsulBzbV6nDsmqsZSfWQT9H3j0MXf', 'siswa', '2018-03-05 14:48:21', '2018-03-05 14:48:21'),
(8, 'bagja', 'riki.subagja@gmail.com', '$2y$10$yT3WhV84zW0OvwHmvY/dF.gNrfWgOFn9YTLKfdDSGLiU5gbp8V4ey', 'Lnm4esJTFL8eEREhkAVFjRk5aC6zBW26d3oHK5Wg3apWW3BdLH4260TL7yff', 'siswa', '2018-03-05 14:48:47', '2018-03-05 14:48:47'),
(9, 'blackluther', 'whisnu.mulya@gmail.com', '$2y$10$68fDnS3gxr3ohyZddZ783.y4P2bPz9EgCjwkSRNtZjHeqFHYMu8u6', 'kB3CidTYbUticNxWx3EJbjAXMudQG4iCwnuumNpxztyqW7GFPFT2PPKc3Bx2', 'siswa', '2018-03-05 14:51:10', '2018-03-05 14:51:20'),
...
(11, 'npras', 'n.pras@gmail.com', '$2y$10$p/LphJvxZomwRgILmYEx7uQD3o5f4EbsPo8B6pN91Gkq/S.Dk6Eyq', 'MRyaMKC6suyYtFX6lnJUDjo6OYt9qff9Tz7xvQTcF05PBPmuZSfJNjA52iqD', 'siswa', '2018-03-05 14:54:25', '2018-03-05 14:54:25'),
(12, 'jantung', 'hentaikyun@gmail.com', '$2y$10$NF10r/vY2Pec4b5hHlL1d.XcbQYp5VudISoFb1OZjIRJa2WcBE8Y6', 'BnjabiotGF9uRwJp113rGfDz9WGr0Us05yIcCSeuttg5pKVUoAnNHWXeXeIA', 'siswa', '2018-03-05 14:56:41', '2018-03-05 14:56:41'),
...
(14, 'laracry', 'mzfahri620@gmail.com', '$2y$10$tDcmXuHyf0qm.vlCHGhf/ufbcrC01o99T0Edz4zbPHI4sdVkUc9ja', 'VrYJUfkBbuUloJMInXNSbWaX8u9vFlZrz52C5zBXbX3ppjY60Nrkrurz2HKn', 'admin', '2018-03-13 14:39:31', '2018-03-13 14:39:35'),
(15, 'sfso', 'sfso@gmail.com', '$2y$10$bJw.4z9GJHvPFkpiIZtwY.2h90nkgSYFJfbuTtBokZycZYizYCStm', '1eMeAriFiZKiuCjYXY2Szes8JX52kg7agFz8TAZhcMt6oujutPU90jSN0Jtx', 'guru', '2018-03-18 04:08:07', '2018-03-25 02:24:56');
...
--
ALTER TABLE `bidang_keahlian`
  MODIFY `id_bidang_keahlian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `jawaban_siswa_remed`
  MODIFY `id_jawaban_remedial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `nilai_remedial`
  MODIFY `id_nilai_remedial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `soal_remed`
  MODIFY `id_soal_remedial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `ujian`
--
ALTER TABLE `ujian`
  MODIFY `id_ujian` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key.', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `ujian_remedial`
--
ALTER TABLE `ujian_remedial`
  MODIFY `id_ujian_remedial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
