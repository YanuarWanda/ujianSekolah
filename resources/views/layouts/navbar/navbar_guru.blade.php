<nav class="navbar navbar-dark bg-main">
    <div class="container justify-content-between">
        ...
        <div class="btn-group">
            ...
            <a href="{{ url('guru/profil') }}" class="btn btn-dark" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="dropdown-toggle-split fas fa-caret-down"></i></a>
            <div class="dropdown-menu dropdown-menu-right">
                <a href="{{ url('guru/profil') }}" class="dropdown-item"><i class="fas fa-user fa-fw"></i>&nbsp;Profil</a>
