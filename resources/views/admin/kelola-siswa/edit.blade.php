            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a data-toggle="tab" href="#editAkun">Edit Akun</a></li>
                    </ul>
                    <div class="tab-content">
                        <div id="editData" class="tab-pane fade in active"><br>
                            <form class="form-horizontal" method="POST" action="{{url('/kelola-siswa/update', base64_encode($data->nis) )}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                        ...
                        <div id="editAkun" class="tab-pane fade in"><br>
                            <form class="form-horizontal" method="POST" action="{{url('/kelola-siswa/updateAkun', base64_encode($data->id_users) )}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
