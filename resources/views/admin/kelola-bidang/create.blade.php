    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading">Tambahkan Bidang Keahlian</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('/kelola-bidang/create') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('bidang_keahlian') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="bidang_keahlian" type="text" class="form-control" name="bidang_keahlian" value="{{ old('bidang_keahlian') }}" required autofocus>
