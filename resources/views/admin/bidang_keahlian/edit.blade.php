...
@include('layouts/navbar/navbar_admin')
            <div class="content p-4">
                ...
                <form action="{{ url('bidang_keahlian/edit', base64_encode($bidang_keahlian->id_daftar_bidang)) }}" method="POST" id="formEditBidangKeahlian">
                    {{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <div class="input-group" id="bidang_keahlian_nest">
                            ...
                            <input type="text" class="form-control" id="bidang_keahlian" name="bidang_keahlian" placeholder="Masukkan nama bidang keahlian" value="{{ $bidang_keahlian->bidang_keahlian }}">
                        </div>
                    </div>
                    ...
                    <div class="btn-group btn-block">
                        ...
                        <button type="submit" class="btn btn-membesar btn-primary" data-toggle="tooltip" data-placement="bottom" title="Update Data Bidang Keahlian"><i class="fas fa-edit"></i></button>
                    </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#formEditBidangKeahlian').on('submit', function(e){
            e.preventDefault();
