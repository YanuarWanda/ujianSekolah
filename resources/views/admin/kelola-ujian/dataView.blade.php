                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <!-- <div class="col-sm-4"> -->
                                            <div class="col-sm-4">
                                                <a class="text-center btn btn-primary btn-block" href="{{ url('/daftar-nilai', base64_encode($isi->id_ujian)) }}" style="height:90px"><i class="fa fa-book fa-4x"></i><br><center><small>Daftar Nilai</small></center></a>
                                            </div>
                                            <div class="col-sm-4">
                                                @if($isi->status == 'Draft')
                                                <button type="button" class="btn btn-info btn-block" data-toggle="modal" data-target="#post_{{$u}}" style="margin-top: 25px">Post Ujian</button>
                                                @else
                                                <a class="text-center btn btn-info btn-block" id="unpostModal" href="{{url('/kelola-ujian/DRAFT', base64_encode($isi->id_ujian))}}" style="margin-top: 25px">Unpost Ujian</a>
                                                @endif
                                            </div>
                                            <div class="col-sm-4">
                                                <a class="text-center btn btn-warning btn-block" href="{{url('/kelola-ujian/edit', base64_encode($isi->id_ujian))}}" style="margin-top: 25px">Detail Ujian</a>
                                            </div>
                                        </div>
                                        <hr>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <a class="text-center btn btn-primary btn-block" href="{{ url('/daftar-nilai', base64_encode($isi->id_ujian)) }}" style="height:100px"><i class="fa fa-book fa-4x"></i><br>Daftar Nilai</a>
                                </div>
