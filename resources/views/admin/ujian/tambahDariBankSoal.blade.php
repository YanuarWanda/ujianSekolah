...
<div class="container p-5">
    <h1 class="text-center">Tambah Soal Dari Bank Soal | {{ $ujian->judul_ujian }}</h1>
            ...
            <tbody>
                @foreach($soal as $s => $sIsi)
                    <tr>
                        ...
                        <td>{!! $sIsi->jawaban !!}</td>
                        <td>
                            <a class="btn btn-primary" data-toggle="modal" data-target="#tambahModal" id="{{ $sIsi->id_bank_soal }}"><i class="fas fa-plus">&nbsp;Tambahkan Soal</i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    @endif
    <a href="{{ url('ujian/edit', base64_encode($ujian->id_ujian)) }}" class="btn btn-danger btn-block"><i class="fas fa-arrow-left"></i></a>
</div>

<div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="tambahModalLabel">
