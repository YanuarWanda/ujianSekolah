...
<div class="container text-dark p-5">
    ...
    <div class="tab-content" id="tabBuatEdit">
        <div class="tab-pane fade show active" id="edit" role="tabpanel" aria-labelledby="edit-tab">
            ...
            <form action="{{ url('ujian/edit', base64_encode($ujian->id_ujian)) }}" method="POST" id="formTambahUjian">
                {{ csrf_field() }}
        ...
        <div class="tab-pane fade" id="soal" role="tabpanel" aria-labelledby="soal-tab">
                ...
                <tbody>
                    ...
                    @foreach($soal as $s)
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-block">
                                    <a href="{{ url('/ujian/editSoalUjian', base64_encode($s->id_soal)) }}" class="btn btn-info btn-membesar half"><i class="fas fa-edit"></i></a>
                                    <button type="button" href="{{ url('/ujian/deleteSoalUjian', base64_encode($s->id_soal)) }}" class="btn btn-danger btn-membesar half deleteButton"><i class="fas fa-trash"></i></button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
            ...
            <div class="btn-group btn-block caraTambah">
                <a href="{{ url('/ujian/tambahDariBankSoal', base64_encode($ujian->id_ujian)) }}" class="btn btn-info btn-block">Import dari Bank Soal</a>
                <a href="{{ url('/ujian/tambahSoalUjian', base64_encode($ujian->id_ujian)) }}" class="btn btn-primary btn-block">Tambah Soal Sendiri</a>
            </div>
        </div>
    </div>
</div>
