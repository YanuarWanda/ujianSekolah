...
<div class="container text-dark">
    <div class="card mt-2 mb-2">
        ...
        <form action="{{ url('ujian/remed/tambahSoalRemed', base64_encode($ujianRemedial->id_ujian_remedial)) }}" method="POST">    
            {{ csrf_field() }}
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
            ...
            <div class="card-footer">
                <div class="btn-group btn-block">
                    <a href="{{ url('ujian/remed/detail', base64_encode($ujianRemedial->id_ujian_remedial)) }}" class="btn btn-membesar btn-danger" data-toggle="tooltip" data-placement="bottom" title="Kembali"><i class="fas fa-arrow-left"></i></a>
