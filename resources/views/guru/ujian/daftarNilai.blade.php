...
@include('layouts/navbar/navbar_guru')
    <div class="container text-dark mt-2">
        <a href="{{url('guru/ujian/nilai/export', base64_encode($ujian->id_ujian))}}" class="btn btn-primary btn-fixed-bottom-right">Export Nilai</a>
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header text-center title"><strong>Grafik Rata-Rata Nilai per Kelas</strong></div>
                    <div class="card-body">
                        <canvas id="chartPerKelas" height="335px"></canvas>
                    </div>
                </div>
            </div>
            <div class="col-lg-8">
                        ...
                        <?php $no=1;?>
                            @foreach($jumlahNilai as $n => $isiJumlah)
                                <div class="block" data-panel="Kelas_{{$n}}">
                                    <button type="button" class="btn btn-primary btn-block btnKelas">{{ $isiJumlah['nama_kelas'] }}</button>
                                </div>
