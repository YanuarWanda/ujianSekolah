...
<div class="container text-dark mt-2 mb-2">
    ...
    <div class="tab-content" id="tabBuatEdit">
        <div class="tab-pane fade show active" id="edit" role="tabpanel" aria-labelledby="edit-tab">
            <div class="card">
                <form action="{{ url('guru/ujian/remed/detail', base64_encode($ujianRemedial->id_ujian_remedial)) }}" method="POST">
                    {{ csrf_field() }}
                    <div class="card-body">
        ...
        <div class="tab-pane fade" id="soal" role="tabpanel" aria-labelledby="soal-tab">
                            ...
                            <tbody>
                                ...
                                @foreach($soal as $s)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-block">
                                                <a href="{{ url('guru/ujian/remed/editSoalRemed', base64_encode($s->id_soal_remedial)) }}" class="btn btn-info" data-toggle="tooltip" data-placement="bottom" title="Edit Soal"><i class="fas fa-edit"></i></a>
                                                <button type="button" href="{{ url('guru/ujian/remed/deleteSoalRemed', base64_encode($s->id_soal_remedial)) }}" class="btn btn-danger deleteButton" data-toggle="tooltip" data-placement="bottom" title="Hapus Soal dari Ujian"><i class="fas fa-trash"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
            ...
            <div class="btn-group btn-block caraTambah">
                <a href="{{ url('guru/ujian/remed/tambahDariBankSoal', base64_encode($ujianRemedial->id_ujian_remedial)) }}" class="btn btn-info btn-block">Import dari Bank Soal</a>
                <a href="{{ url('guru/ujian/remed/tambahSoalRemed', base64_encode($ujianRemedial->id_ujian_remedial)) }}" class="btn btn-primary btn-block">Tambah Soal Sendiri</a>
            </div>
        </div>
    </div>
</div>
